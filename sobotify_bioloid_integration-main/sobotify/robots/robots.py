...
LIST_OF_ROBOTS=("stickman","pepper","nao","cozmo","mykeepon","bioloid")

def get_names() :
    return LIST_OF_ROBOTS

def get_vision(name,robot_ip,cam_device) :
        if name=='stickman' or name=='pepper' or name=='pepper_sim' or name=='nao' or name=='nao_sim' or  name=='mykeepon'or  name=='bioloid':
...
def get_sound(name,robot_ip,sound_device) :
        if name=='stickman' or name=='pepper' or name=='pepper_sim' or name=='nao' or name=='nao_sim' or  name=='mykeepon' or name=='cozmo' or  name=='bioloid':
            import sobotify.robots.stickman.stickman as stickman
...
def get_gesture_converter(name) :
    if name=='stickman' :
        ...
        import sobotify.robots.bioloid.landmarks2angles as landmarks2angles
        return landmarks2angles.convert
    else :
        print("unknow robot :" + str(name))
        return None                   
...
def get_all_interfaces(name,robot_ip,robot_options,cam_device,sound_device) :
        ...
        parser.add_argument('--bioloid',default="",nargs="+",help='bioloid specific options')
        ...
        if name=='stickman' :
            ...
            PORT=robot_ip
            import sobotify.robots.bioloid.bioloid as bioloid
            my_bioloid=bioloid.Bioloid(PORT,cam_device,sound_device)
            return my_bioloid
        else :
            print("unknow robot :" + str(name))
            exit()    
